...
@python_app
def glue_13_attempt(graph_obj_1, a, graph_obj_2, b, output_path):
    import networkx as nx
    import itertools
    import enum
...
file_to_read = open("13gluingproblems", "rb")
gluing_problems = pickle.load(file_to_read)
file_to_read.close()

# graph1 = gluing_problems[0][0]
# graph2 = gluing_problems[0][1]
# a = "a"
# b = "b"
# output_path = "12-graphs/12iso"+str(0)+".g6"
# res = glue_12_attempt(graph1, a, graph2, b, output_path)
# print(res)
...
for problem in gluing_problems:
    ...
    a = "a"
    b = "b"
    output_path = "13-graphs/13iso"+str(index)+".g6"
    gluing_attempts.append( glue_13_attempt(graph1, a, graph2, b, output_path) )
    index += 1
