...
def save_problems(problem_dict, deg, count, num_col):
    file_name = "14-problems/14gluingproblems"+str(deg)+"-"+str(count) + ".bz2"
    problem_list = []
...
file_to_read = open("pointed_graphs_3", "rb")
pointed_graphs_3 = pickle.load(file_to_read)
file_to_read.close()

file_to_read = open("pointed_graphs_4", "rb")
pointed_graphs_4 = pickle.load(file_to_read)
file_to_read.close()

file_to_read = open("pointed_graphs_5", "rb")
pointed_graphs_5 = pickle.load(file_to_read)
file_to_read.close()

file_to_read = open("pointed_graphs_6", "rb")
pointed_graphs_6 = pickle.load(file_to_read)
file_to_read.close()

file_to_read = open("pointed_graphs_7", "rb")
...
all_pointed_graphs = [pointed_graphs_7, pointed_graphs_3, pointed_graphs_4, pointed_graphs_6, pointed_graphs_5]
deg_list = [7,3,4,6,5]
