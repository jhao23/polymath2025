...
@python_app
def glue_15_attempt(graph_obj_1, a, graph_obj_2, b, output_path):
    import networkx as nx
    import itertools
...
file_to_read = open("15gluingproblems", "rb")
...
for problem in gluing_problems:
    ...
    a = "a"
    b = "b"
    output_path = "15-graphs/15iso"+str(index)+".g6"
    gluing_attempts.append( glue_15_attempt(graph1, a, graph2, b, output_path) )
    index += 1
